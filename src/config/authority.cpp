...
void config_authority_allocate_n(v8::FunctionCallbackInfo<v8::Value> const& args) {
    Isolate* isolate = args.GetIsolate();

    if (args.Length() != 1) {
        throw_exception(isolate, "Wrong number of arguments. config_authority_allocate_n function requires 1 arguments.");
        return;
    }
    ...
    kth_authority* res = kth_config_authority_allocate_n(n);
